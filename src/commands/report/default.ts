...
export const desc = "Post a Kengine report to file or stdout";

export const builder: CommandBuilder<Options, Options> = (yargs) => {
  return yargs
    .options({
      ...baseOptions,
      "out-file": { type: "string", desc: "Path to the Kengine output file", required: false },
    })
    .example([
      [
        `
      ...
      $0 report --out-file <path-to-kengine-output>
      `,
      ],
    ])
