...
export const desc = "Post a Kengine report to GitHub";
...
export const builder: CommandBuilder<Options, Options> = (yargs) => {
  return yargs
    .options({
      ...
      path: { type: "string", desc: "Path to the Kengine output file", required: false },
    })
    .example([
      [
        `
      ...
      # Post a report to GitHub with explicit path to Kengine output file:
      $0 github --repo <org/repo> --pull-request <pr-number> --path <path-to-kengine-output> --github-token <github-token>
      `,
      ],
    ])
